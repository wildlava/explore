...
public class ExploreControllerTest {
   ...
   public void caveShouldReturnCorrectResponseAtStart() throws Exception {
      this.mvc.perform(get("/adventures/cave"))
         ...
         .andExpect(jsonPath("$.state", is("3:3:L_mt-1R8pxBlK9ySamZB9DDhXvPJss-GKA9igbuVMdUpTD_ZTVhdgDP8q5RA6EXCm0YQgspkyker8yFH7bNLc88OUUIrscGccSVDEfGYUJRLrnWC44vqRqkQP8JxusPyN6xo3m3wddq6ZeP9vyeZLAwL")));
   }
   ...
   public void caveShouldReturnCorrectResponseGoingEastFromStart() throws Exception {
      MockHttpServletRequestBuilder request = post("/adventures/cave/e")
         ...
         .content("{\"state\": \"3:3:L_mt-1R8pxBlK9ySamZB9DDhXvPJss-GKA9igbuVMdUpTD_ZTVhdgDP8q5RA6EXCm0YQgspkyker8yFH7bNLc88OUUIrscGccSVDEfGYUJRLrnWC44vqRqkQP8JxusPyN6xo3m3wddq6ZeP9vyeZLAwL\"}");
      ...
      this.mvc.perform(request)
         ...
         .andExpect(jsonPath("$.prompt", is(":")))
         .andExpect(jsonPath("$.suspend", is(false)))
         .andExpect(jsonPath("$.state", is("3:3:L_mt-yR4ZxFlbszibiYEcyRD3phIw6RRQRDKprSREZVYWWT5qVUQmpUB7brmQyAcnX5GiWulvuoNVx2pDgnQsGdOe6oqHTqNZupdtDuv7buSMRGYYKZhBvI3HNxQIv1q9_d33oWrL9nCKb2plSGexQwJ")));
   }
   ...
   public void caveShouldReturnCorrectResponseGoingSouthFromDimlyLitRoom() throws Exception {
      MockHttpServletRequestBuilder request = post("/adventures/cave/s")
         .contentType(MediaType.APPLICATION_JSON)
         .content("{\"state\": \"3:3:L_mt-yR4ZxFlbszibiYEcyRD3phIw6RRQRDKprSREZVYWWT5qVUQmpUB7brmQyAcnX5GiWulvuoNVx2pDgnQsGdOe6oqHTqNZupdtDuv7buSMRGYYKZhBvI3HNxQIv1q9_d33oWrL9nCKb2plSGexQwJ\"}");
      ...
      this.mvc.perform(request)
         ...
         .andExpect(jsonPath("$.prompt", is(":")))
         .andExpect(jsonPath("$.suspend", is(false)))
         .andExpect(jsonPath("$.state", is("3:3:L_mt-1R4phBlbszSbsrkfhp2NErxskPXAF2b5QqQ0d8DyiGNH6LhrI0F_0j0TkZunfippXkdOP3ntiMztuc31HG5YoigM1ww05WvmtBYrM_ngTQJplWp5ljuTviBWfD8Ni1J_qar8zeCZez9nyecWAwP")));
   }
   ...
   public void caveShouldReturnCorrectResponseWhenLookingInDimlyLitRoomWithSuspendedGame() throws Exception {
      MockHttpServletRequestBuilder request = post("/adventures/cave/look")
         .contentType(MediaType.APPLICATION_JSON)
         .content("{\"state\": \"3:3:L_mt-yR4ZxFlbszibiYEcyRD3phIw6RRQRDKprSREZVYWWT5qVUQmpUB7brmQyAcnX5GiWulvuoNVx2pDgnQsGdOe6oqHTqNZupdtDuv7buSMRGYYKZhBvI3HNxQIv1q9_d33oWrL9nCKb2plSGexQwJ\", \"lastSuspend\": \"3:3:L_mt-1R8pxBlK9ySamZB9DDhXvPJss-GKA9igbuVMdUpTD_ZTVhdgDP8q5RA6EXCm0YQgspkyker8yFH7bNLc88OUUIrscGccSVDEfGYUJRLrnWC44vqRqkQP8JxusPyN6xo3m3wddq6ZeP9vyeZLAwL\"}");
